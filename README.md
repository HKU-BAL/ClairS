...
## Latest Updates
*v0.5.1 (Sep 9, 2026)* : 1. Added the `ont_r10_dorado_hac_5khz_v6` platform (`-p ont_r10_dorado_hac_5khz_v6`), which enables ONT Dorado HAC 5kHz v6 model. 2. Rebuilt the Docker image with the latest Clair3 version and model(v2.0.3). 3. Added `--gender` and `--par_regions_bed` to support sex-chromosome ploidy-aware germline calling([#66](https://github.com/HKU-BAL/ClairS/issues/66)).
